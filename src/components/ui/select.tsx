...
export const selectVariants = tv({
  slots: {
    ...
    triggerIcon: [
      ...
      // disabled
      'group-disabled/trigger:text-text-disabled-300 group-data-[placeholder]/trigger:group-disabled/trigger:text-text-disabled-300',
      'group-disabled/trigger:[&:not(.tabler-icon)]:opacity-[.48]',
    ],
    selectItemIcon: [
      'size-5 shrink-0 bg-[length:1.25rem] text-text-sub-600',
      // 'group-has-[&]-ml-0.5',
      // disabled
      '[[data-disabled]_&:not(.tabler-icon)]:opacity-[.48] [[data-disabled]_&]:text-text-disabled-300',
    ],
  },
  variants: {
    size: {
  ...
  return (
    ...
    >
      ...
      <SelectPrimitives.Icon asChild>
        <IconChevronDown className={triggerArrow()} />
  ...
  return (
    ...
    >
      ...
      <SelectPrimitives.ItemIndicator asChild>
        <IconCheck className='absolute right-2 top-1/2 size-5 shrink-0 -translate-y-1/2 text-text-sub-600' />
