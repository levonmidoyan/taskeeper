...
import { Card, CardContent, CardFooter } from "@/components/auth/ui/card"
import { Field, FieldError, FieldLabel } from "@/components/auth/ui/field"
...
function SetPassword({ className }: { className?: string }) {
  ...
  return (
    <div>
      <h2 className="mb-3 text-label-md text-text-strong-950">
        ...
        <CardContent className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          {sentEmail ? (
            <div className="flex flex-col gap-3 items-start sm:items-end">
              <p className="text-paragraph-sm text-text-strong-950" role="status">
