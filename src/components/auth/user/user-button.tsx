...
export function UserButton({
  ...
  return (
    <DropdownMenu>
          ...
          <>
            {session || sessionPending || settingActiveSession ? (
              ...
              <>
                ...
                <div className="grid flex-1 text-left text-paragraph-sm leading-tight">
      ...
      <DropdownMenuContent
        className={cn(
          "min-w-40 md:min-w-56 max-w-[48svw]",
          // Plugin items (admin link, stop impersonating) can render nothing,
          // which would leave two separators back to back.
          "[&>[role=separator]+[role=separator]]:hidden"
        )}
        side={side}
      ...
      >
        {session && (
          <>
            <DropdownMenuGroup>
              <DropdownMenuLabel className="text-paragraph-sm font-normal">
                <UserView />
              </DropdownMenuLabel>
            </DropdownMenuGroup>
        ...
        {session ? (
          <>
            ...
            {!hideSettings && (
              ...
              >
                <Settings className="text-text-sub-600" />
            ...
            >
              <LogOut className="text-text-sub-600" />
          ...
          <>
            ...
            >
              <LogIn className="text-text-sub-600" />
            ...
            >
              <UserPlus2 className="text-text-sub-600" />
